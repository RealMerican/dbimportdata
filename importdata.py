...
#datapath = "/Users/eomalle1/Desktop/Database/test_data/"
...
# ratings = list()
# ratings.append('ratings_short.list')
# plots = list()
# plots.append('plot_short.list')

###UPDATE PROD FILE INPUTS BELOW
os.chdir(datapath)
actors = list()
actors.append('actresses.list')
actors.append('actors.list')
directors = list()
directors.append('directors.list')
producers = list()
producers.append('producers.list')
writers = list()
writers.append('writers.list')
genres = list()
genres.append('genres.list')
ratings = list()
ratings.append('mpaa-ratings-reasons.list')
plots = list()
plots.append('plot.list')
...
for fname in actors:
	...
	for line in fhand:
		...
		#skip blank lines
 		...
 		cur.execute('''INSERT OR IGNORE INTO Roles (title, year, actor, role) 
 			  VALUES(?, ?, ?, ?)''', (t, y, actor, r ) )
		print actor, y, t	
	conn.commit()
...
#GOALS:
	...
	#SET RAW_INPUT FUNCTION FOR ENTERING ACTOR/FILM DIVERSITY -- use while True loop ex?
	#Group maintained db?
